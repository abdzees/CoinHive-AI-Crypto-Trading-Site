      ...
      <div className="container mx-auto px-4">
        <ScrollReveal>
          <SectionHeading
            ...
            subtitle="Choose the plan that best fits your trading needs and scale as your portfolio grows."
            centered
          />
        </ScrollReveal>
            ...
            <ScrollReveal key={index} delay={index * 100}>
              <GlassmorphicCard className={`relative h-full flex flex-col ${plan.isPopular ? 'border-gold' : ''}`}>
                ...
                <a 
                  ...
                  className={`neumorphic-button text-center w-full ${plan.isPopular ? 'bg-gold text-white hover:bg-gold-dark' : ''}`}
                >
                  {plan.buttonText}
                </a>
              </GlassmorphicCard>
