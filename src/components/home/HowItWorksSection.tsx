...
export const HowItWorksSection: React.FC = () => {
  return <section id="how-it-works" className="py-20 my-[10px]">
      <div className="container mx-auto px-4">
        <ScrollReveal>
          <SectionHeading title="How CoinHive Works" subtitle="Getting started with automated AI trading is simple. Just follow these three steps to begin your journey." centered />
        </ScrollReveal>
