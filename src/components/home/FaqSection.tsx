        ...
        <div className="max-w-3xl mx-auto mt-12">
          {faqs.map((faq, index) => (
            <ScrollReveal key={index} delay={index * 50}>
              <div className="mb-4">
                <button
                  className="flex items-center justify-between w-full text-left p-5 rounded-lg bg-card shadow-sm hover:shadow transition-shadow"
                ...
                {openIndex === index && (
                  <div className="mt-2 p-5 bg-card rounded-lg shadow-sm">
